...
class adInfoHRLTD3(object):
    ...
    def __init__(self, sess, env, state_dim, action_dim, action_bound, batch_size=64, tau=0.001, option_num =5,
                 actor_lr=0.0001, critic_lr=0.001, option_lr=0.001, gamma = 0.99, hidden_dim=(400, 300), entropy_coeff = 0.1, c_reg=1.0, vat_noise=0.005, c_ent=4):
        self.env = env
        self.sess = sess
    ...
    def max_option(self, inputs):
        ...
        # print('Q_predict.shape', np.asarray(Q_predict).shape)
